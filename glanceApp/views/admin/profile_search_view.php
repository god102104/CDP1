        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo $heading;?>으로 검색 결과</h3>
            </div>
            <!-- /.box-header -->
            <?php
            ...
            <table id="example2" class="table table-bordered table-hover">
			  ...
			  ?>
              <tr>
                <td><?php echo date('Y-d-m',strtotime($profile->dated));?></td>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url().'admin/profile_detail/profile_sts/'.$profile->id.'/'.$stsConvert;?>">회원 <?php echo ucwords($stsConvert);?></a>
                </td>
              </tr>
              <?php
			  $i++;
