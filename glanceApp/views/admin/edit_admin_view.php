...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side"> 
    ...
    <section class="content-header">
      <h1> 관리자 관리<!--<small>advanced tables</small>--> 
      </h1>
    </section>
          ...
          <div class="box">
            ...
            <form action="<?php echo base_url()."admin/home/update_pass"; ?>" method="post">
              <table width="100%" border="0">
                <tr>
                  <td width="19%" align="right" valign="top"><strong>새 비빌번호 :</strong>&nbsp;</td>
                  <td width="81%">
                ...
                <tr>
                  <td width="19%" align="right" valign="top"><strong>비밀번호 확인 :</strong>&nbsp;</td>
                  <td width="81%">
