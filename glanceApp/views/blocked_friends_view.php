							...
							<div class="col-md-12 col-sm-12">
								...
								<div class="job-new-list">
									...
									<div class="vc-content">
										<h5 class="title"><a href="<?php echo base_url(); ?>profile/<?php echo $row->username; ?>" title="<?php echo $row->name;?>"><?php echo $row->name;?></a><span class="jb-age">(<?php echo count_years($row->dob,date("Y-m-d"));?>세 | <? echo (($row->gender) == 'Male')?'남성':'여성';?>)</span><span class="j-full-time"><? echo (($row->division) == 'yoyang')?'요양사':'채용자';?></span></h5>
									...
									<a class="btn btn-black bn-apply" href="<?php echo base_url(); ?>friends/unblock_friend/<?php echo my_encrypt($row->id); ?>">제외<i class="ti-arrow-right ml-1"></i></a>
								</div>
