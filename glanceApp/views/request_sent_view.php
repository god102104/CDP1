						...
						<div class="row">
							...
							<div class="col-md-12 col-sm-12">
								...
								<div class="job-new-list">
									...
									<span class="btn btn-black bn-det"><?php switch($row->status) {case 'pending': echo '대기'; break; case 'discard': echo '거절'; break; case 'blocked': echo '차단'; break; case 'approved': echo '승인'; break; }?></span>
							...
							<?php } else { ?>
								...
								<div class="job-new-list">
									...
									<div class="vc-content">
										<h5 class="title"><a href="<?php echo base_url(); ?>profile/<?php echo $row->username; ?>" title="<?php echo $row->name;?>"><?php echo $row->name_mask;?></a><span class="jb-age">(<?php echo count_years($row->dob,date("Y-m-d"));?>세 | <? echo (($row->gender) == 'Male')?'남성':'여성';?>)</span><span class="j-full-time"><? echo (($row->division) == 'chaeyong')?'채용자':'요양사';?></span></h5>
