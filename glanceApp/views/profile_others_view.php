							...
							<div class="single-job-head head-light style-1 mb-0">
								<div class="single-job-left">
									<div class="single-job-thumb">
										<img src="<?php echo ($row->photo)?base_url().'glancePublic/uploads/member_images/thumb_'.$row->photo:base_url().'glancePublic/images/no-image.jpg';?>" alt="">
									</div>
									<div class="single-job-info">
										<h4 class="single-job-title"><? echo $row->name_mask;?> <span class="job-age">(<?php echo $row->mAge;?>세 | <? echo (($row->gender) == 'Male')?'남성':'여성';?>)</span><span class="job-type full-time"><? echo (($row->division) == 'yoyang')?'요양사':'채용자';?></span></h4>
										<span class="sj-location"><i class="ti-mobile"></i><? echo ($row->phone)?></span>
										<ul class="tags-jobs">
								...
								<div class="listing-detail_right right-area">
									<div class="listing-detail-item">
										<?php $is_already_friend = $this->friend_model->friendship_validations($row->id);
											if(!$is_already_friend): 
										?>
											<a href="<?php echo base_url(); ?>friends/send_friend_request/<?php echo my_encrypt($row->id); ?>" class="btn btn-green full-width"><i class="ti-link mr-2"></i> 매칭 신청</a>
										<?php elseif($is_already_friend->status =='pending') : ?>
											<a href="<?php echo base_url(); ?>friends/request_sent" class="btn btn-inverse full-width"><i class="ti-unlink mr-2"></i> 매칭 대기</a>
										<?php else: ?>
						...
						<div class="col-md-4 col-sm-12">
							...
							<div class="apply-wrap-buttons">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6">
										<div class="input-group">
											<a href="<?php echo base_url(); ?>friends/add_to_favourite/<?php echo my_encrypt($row->id);?>" class="btn btn-blue favorite"><i class="ti-heart"></i> 즐겨찾기 추가</a>
										</div>
									</div>
									<?php else : ?>
									<div class="col-lg-6 col-md-6 col-sm-6">
