						...
						<div class="row">
							...
							<div class="col-md-12 col-sm-12">
								...
								<div class="job-new-list">
									...
									<div class="vc-content">
										<h5 class="title"><a href="<?php echo base_url(); ?>profile/<?php echo $row->username; ?>"><?php echo $row->name_mask;?></a><span class="jb-age">(<?php echo count_years($row->dob,date("Y-m-d"));?>세 | <? echo (($row->gender) == 'Male')?'남성':'여성';?>)</span><span class="j-full-time"><? echo (($row->division) == 'yoyang')?'요양사':'채용자';?></span></h5>
									...
									<a class="btn btn-black bn-apply" href="<?php echo base_url(); ?>friends/accept_friend_request/<?php echo my_encrypt($row->member_id); ?>">매칭<i class="ti-arrow-right ml-1"></i></a>
									<a class="btn btn-black bn-not" href="<?php echo base_url(); ?>friends/reject_friend_request/<?php echo my_encrypt($row->member_id); ?>">거절 <i class="ti-close"></i></a>
							...
							<?php } else { ?>
								...
								<div class="job-new-list">
									...
									<div class="vc-content">
										<h5 class="title"><a href="<?php echo base_url(); ?>profile/<?php echo $row->username; ?>"><?php echo $row->name_mask;?></a><span class="jb-age">(<?php echo count_years($row->dob,date("Y-m-d"));?>세 | <? echo (($row->gender) == 'Male')?'남성':'여성';?>)</span><span class="j-full-time"><? echo (($row->division) == 'chaeyong')?'채용자':'요양사';?></span></h5>
									...
									<a class="btn btn-black bn-apply" href="<?php echo base_url(); ?>friends/accept_friend_request/<?php echo my_encrypt($row->member_id); ?>">매칭<i class="ti-arrow-right ml-1"></i></a>
									<a class="btn btn-black bn-not" href="<?php echo base_url(); ?>friends/reject_friend_request/<?php echo my_encrypt($row->member_id); ?>">거절<i class="ti-arrow-right ml-1"></i></a>
