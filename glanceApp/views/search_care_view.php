				...
				<div class="container">
					<div class="col-lg-12 col-md-12">
						<div class="pt-caption text-center">
							<h1 class="text-white">요양사 검색</h1>
						</div>
					</div>
					<form name="search_frm" id="search_frm" action="<?php echo base_url();?>search_care" method="post" class="search-big-form no-border search-shadow">
						<div class="row m-0">
							...
							<div class="col-lg-2 col-md-2 col-sm-12 p-0"> <!-- 지역-->
								<div class="form-group">
									...
									<select name="work_zone" id="work_zone" class="form-control">
										<option value="<?php echo set_value('work_zone'); ?>" selected="selected"><?php echo (set_value('work_zone'))?set_value('work_zone'):'지역'; ?></option>
							...
							<div class="col-lg-2 col-md-2 col-sm-12 p-0"> <!-- 나이-->
								<div class="form-group">
									<i class="fas fa-birthday-cake"></i>
									<select name="age_frm" id="age_frm" class="form-control">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							...
							<a href="<?php echo base_url();?>search_care">요양사 검색</a>
						</div>
					</div>
				</div>
			</div>	
					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-4 app-hidden">
							...
							<div class="d-block d-none d-sm-block d-md-none mb-3">
								<a href="javascript:void(0)" onclick="openNav()" class="btn btn-info full-width btn-md"><i class="ti-filter mrg-r-5"></i> 검색 필터</a>
							</div>
								...
								<div class="col-md-12 mb-1">
									<div class="layout-switcher-wrap">
										...
										<div class="layout-switcher">
											<ul>
												<li class="active"><a href="<?php echo base_url();?>search_care"><i class="ti-layout-grid3"></i></a></li>
								...
								<?php
									...
									if($search_row) :
										foreach($search_row as $searchDetail) :
											...
											if($searchDetail->division == "yoyang") {
								?>
								<!-- Single Employer -->
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="employer-wrap small">
									
										<div class="employer-cover-image" style="background-image: url(<? echo base_url()?>glancePublic/images/thumb_forest_bg.jpg)" data-overlay="2">
										...
										<div class="employer-detail">
											<div class="employer-detail-inner">
												...
												<div class="employer-locations"><i class="ti-location-pin text-danger"></i><?php echo $searchDetail->work_zone;?></div>
												<div class="employer-rating">
													<p><?php echo $searchDetail->work_type;?> | <?php echo $searchDetail->work_day;?> | <?php echo $searchDetail->work_time;?> | <?php switch ($searchDetail->work_career) { case '0': echo '1년 미만'; break; case '1': echo '1년 이상'; break; case '2': echo '2년 이상'; break; case '3': echo '3년 이상'; break; case '5': echo '5년 이상'; break; }?></p>
												</div>
			...
			<!-- care detail Modal -->
			<div class="modal fade" id="care_detail" tabindex="-1" role="dialog" aria-labelledby="registermodal" aria-hidden="true">
					...
					<div class="modal-content" id="registermodal">
						...
						<div class="modal-body">
								...
								<ul>
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="text-danger"><? echo $searchDetail->work_type;?></span>
										</div>
									</li>
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="text-danger"><? echo $searchDetail->work_zone;?></span>
										</div>
									</li>
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="dark text-warning"><? echo $searchDetail->work_day;?></span>
										</div>
									</li>
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="text-purple"><? echo $searchDetail->work_time;?></span>
										</div>
									</li>
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="dark"><?php switch ($searchDetail->work_career) {
																		case '0':
																			echo '초보 가능';
																			break;
																		case '1':
									...
									<li class="job-categories job-categoy">
										<i class="ti-layers"></i>
											...
											<span class="dark"><? echo $searchDetail->work_pay;?></span>
										</div>
									</li>
								</ul>
							</div> <!-- large -->
							...
							<div class="tr-single-box">
								<div class="tr-single-header">
									<h4><i class="ti-write"></i><? echo $searchDetail->work_title;?></h4>
								</div>
								<div class="tr-single-body">
									<p><? echo $searchDetail->work_desc;?></p>
